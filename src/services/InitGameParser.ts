...
export default class InitGameParser implements LineParser {
    ...
    public parse(line: string, parsedData: ParsedData, ctx: ParserContext): void {
        ...
        // 575:01 InitGame: \_Admin\Gamoul\_Location\France\_Website\www.iclan.net\fs_game\mods/efaya_mod_test\g_compassShowEnemies\0\g_gametype\sr\gamename\Call of Duty 4\mapname\mp_naout\protocol\6\shortversion\1.7\sv_allowAnonymous\0\sv_disableClient
        // \0\sv_floodprotect\1\sv_hostname\^7i^1C^7lan.net ^1Efaya_mod\sv_maxclients\32\sv_maxPing\0\sv_maxRate\25000\sv_minPing\0\sv_privateClients\0\sv_punkbuster\0\sv_pure\0\sv_voice\1\ui_maxclients\32
